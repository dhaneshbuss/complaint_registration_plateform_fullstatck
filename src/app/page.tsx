...
export default function LoginPage() {
  const { currentOfficer, loginAsOfficer, loading } = useAuth();
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (password !== 'UPP@123') {
      setError('Invalid Security PIN. Please use default password: UPP@123');
      return;
    }
      ...
      <div className="w-full max-w-lg relative z-10 scanline">
        ...
        <div className="cyber-panel rounded-lg shadow-2xl p-8 border border-border-cyber/30 relative">
          ...
          <form onSubmit={handleLogin} className="space-y-5 mt-3">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-slate-950/70 border border-border-cyber/30 focus:border-primary-cyber focus:outline-none rounded px-3.5 py-2 text-xs font-mono text-white placeholder-slate-600 transition-all shadow-inner"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-slate-950/70 border border-border-cyber/30 focus:border-primary-cyber focus:outline-none rounded pl-3.5 pr-10 py-2 text-xs font-mono text-white placeholder-slate-600 transition-all shadow-inner"
                />
                <button 
                  type="button"
            ...
            <div className="grid grid-cols-2 gap-3.5 pt-1">
              <div className="space-y-1.5">
                ...
                <div className="flex items-stretch gap-2">
                  ...
                  <button
                    ...
                    className="px-2 bg-slate-950 border border-border-cyber/20 hover:border-primary-cyber/45 text-[8px] font-mono text-slate-400 hover:text-primary-cyber rounded transition-colors"
                  >
                    RELOAD
                  </button>
                </div>
              ...
              <div className="space-y-1.5">
                ...
                <input 
                  ...
                  placeholder="Code" 
                  maxLength={5}
                  className="w-full bg-slate-950/70 border border-border-cyber/30 focus:border-primary-cyber focus:outline-none rounded px-3 py-1.5 text-xs font-mono text-white placeholder-slate-600 transition-all uppercase tracking-wider text-center"
                />
              </div>
            </div>
            ...
            <button 
              type="submit"
              className="w-full py-2.5 bg-primary-cyber hover:bg-primary-cyber/90 border border-transparent text-slate-950 font-mono font-bold text-xs uppercase tracking-wider rounded transition-all cursor-pointer shadow-[0_0_15px_rgba(0,210,255,0.2)]"
            >
          ...
          <div className="mt-8 pt-6 border-t border-slate-900">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <button 
                ...
                className="p-2.5 bg-[#0b1328]/60 hover:bg-slate-900 border border-border-cyber/20 hover:border-primary-cyber/50 text-left rounded transition-all group"
              >
